...
function seed(): Activity[] {
  return [
    ...
    entry("a02", "ELE-COLO-1030", "chase", "outbound", "email", "2026-03-13T14:22:00", JOHNNY,
      "Following up on programme item ELE-COLO-1030. We need brackets installed before T Bourke can start fibre. What's your start date?",
    ...
    entry("a04", "ELE-COLO-1030", "chase", "outbound", "email", "2026-03-23T11:40:00", JOHNNY,
      "Pawel, you mentioned you'd confirm Friday. We're now Monday. T Bourke crew sitting. Please advise.",
    ...
    entry("a05", "ELE-COLO-1030", "chase", "outbound", "whatsapp", "2026-03-30T08:50:00", JOHNNY,
      "Pawel — any update on the brackets? T Bourke have called me twice this morning. Costing us money.",
    ...
    entry("a10", "ELE-COLO-1030", "chase", "outbound", "email", "2026-05-08T14:15:00", JOHNNY,
      "Mark, escalating to you directly. The bracketery has been open since 13 March. We have logged 5 chases and 2 commitments from Pawel that were not met. T Bourke are claiming £4,200/day in standing time. Ardmac will seek cost recovery if not resolved by 15 May. Please advise plan.",
