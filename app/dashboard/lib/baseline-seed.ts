...
export const COMPANIES: Company[] = [
  ...
  { slug: "mech-sub", name: "Mech Sub", role: "Subcontractor", colour: "teal", punchLine: "Mechanical sub — CRAH connections, COLO 1-4." },
...
export const BASELINE_TASKS: BaselineTask[] = [
  ...
  { activity_id: "MEC-COLO-1040", name: "Water services and connections COLO 1-4", wbs_path: "Mechanical Modules 1-4", responsible_company: "main-contractor", planned_start: d("21-Apr-26"), planned_end: d("28-Apr-26"), planned_manpower: 5, actual_manpower: 0, status: "blocked", blocked_reason: "Design House holding water services spec. 4 weeks open. MMR1 mech first fix cannot start.", blocking_company: "design-house", affects_room: "MMR1", cost_per_day: 15000 },
...
function fillerTasks(): BaselineTask[] {
  const rows: [string, string, string, string, TaskStatus][] = [
    ...
    ["MEC-COLO-1050", "COLO CRAH connections", "Mechanical Modules 1-4", "mech-sub", "on_track"],
